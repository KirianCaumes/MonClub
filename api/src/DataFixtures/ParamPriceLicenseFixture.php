...
class ParamPriceLicenseFixture extends Fixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $data = [
            ...
            ['id' => 1, 'label' => '2010 à 2008 inclus', 'price_before_deadline' => 135, 'price_after_deadline' => 155, 'min_year' => 2008, 'max_year' => 2010, 'id_season' => 2],
            ['id' => 1, 'label' => '2007 à 2002 inclus', 'price_before_deadline' => 145, 'price_after_deadline' => 165, 'min_year' => 2002, 'max_year' => 2007, 'id_season' => 2],
            ['id' => 1, 'label' => '2001 et avant', 'price_before_deadline' => 160, 'price_after_deadline' => 180, 'min_year' => 1900, 'max_year' => 2001, 'id_season' => 2],
        ];
