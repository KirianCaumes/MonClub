            ...
            <section id="index">
                ...
                <div className="flex-row">
                    <div className="flex-one">
                        <div className="no-margin-left" style={{ background: 'white', margin: '25px', height: '350px', boxShadow: Depths.depth4, textAlign: 'center' }}>
                            <div className="flex-col">
                                <Text variant="xxLarge" nowrap block>
                                    <Icon iconName='AccountManagement' />&nbsp;Titre
                                    </Text>
                    ...
                    <div className="flex-one ">
                        <div className="flex-row">
                            <div className="flex-one" style={{ background: 'white', margin: '25px', height: '150px', boxShadow: Depths.depth4, textAlign: 'center' }}>
                                <div className="flex-col">
                                    <Text variant="xxLarge" nowrap block>
                                        <Icon iconName='AccountManagement' />&nbsp;Titre
                                    </Text>
                            ...
                            <div className="flex-one no-margin-right" style={{ background: 'white', margin: '25px', height: '150px', boxShadow: Depths.depth4, textAlign: 'center' }}>
                                <div className="flex-col">
                                    <Text variant="xxLarge" nowrap block>
                                        <Icon iconName='AccountManagement' />&nbsp;Titre
                            </Text>
